...
public interface SQLConstants {
	...
	String DEALER_NAME_COLUMN = "DEALER_NAME";
	...
	String SEARCH_PARTY_TYPE_CONDITION_SQL = " AND (TYPE = 'DEALER' OR TYPE = 'ADMIN') ";
	...
	String UPDATE_TRANSPORT_SQL = "UPDATE TRANSPORT SET NAME = ?, PRICE=?, BRAND=?, MODEL=?, MANUFACTURER=?, DESCRIPTION=?, SEAT_CAPACITY=?, FUEL_TYPE=?, MILEAGE=?, TRANMISSION_TYPE=?, NUMBER_OF_ENGINE = ?, TRANSPORT_TYPE = ? WHERE ID=?";
	...
	String SEARCH_TRANSPORT_NAME_CONDITION_SQL = " AND NAME LIKE '%?%' ";
	String SEARCH_TRANSPORT_BRAND_CONDITION_SQL = " AND BRAND LIKE '%?%' ";
	String SEARCH_TRANSPORT_MODEL_CONDITION_SQL = " AND MODEL LIKE '%?%' ";
	...
	String SEARCH_ORDER_SQL = "SELECT ORD.ID, ORD.AMOUNT, ORD.CUSTOMER_ID, ORD.DEALER_ID, ORD.ORDER_DATE, " + 
			...
			"LEFT JOIN PARTY P1 ON ORD.DEALER_ID = P1.ID " + 
	...
	String SEARCH_ORDER_DEALER_NAME_CONDITION_SQL = " AND P1.NAME LIKE '%?%' ";
	...
	String GET_PARTY_SQL= "SELECT * FROM PARTY WHERE ID = ? ";
